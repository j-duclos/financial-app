...
echo ""
echo "Credit-card minimums (optional; off until Plaid Liabilities is approved):"
echo "  PLAID_ENABLE_LIABILITIES=false"
echo "  MINIMUM_PAYMENT_FRESHNESS_DAYS=45"
echo "  # PLAID_WEBHOOK_URL=https://${HOST}/api/plaid/webhooks/liabilities/"
