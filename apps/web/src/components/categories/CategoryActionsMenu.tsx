...
export default function CategoryActionsMenu({ onEdit, onArchive, onRestore, onDelete }: Props) {
  ...
  const items: MenuItem[] = [
    ...
    ...(onArchive ? [{ key: "archive", label: "Archive", action: onArchive }] : []),
    ...(onRestore ? [{ key: "restore", label: "Restore", action: onRestore }] : []),
