...
from transactions.services.matching import repair_transfer_leg_duplicates


class Command(BaseCommand):
    help = "Merge duplicate Plaid imports into existing transfer/payment legs."
    ...
    def handle(self, *args, **options):
        ...
        summary = repair_transfer_leg_duplicates(
            user_id=user_id,
