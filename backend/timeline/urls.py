...
from .views import (
    ...
    TimelineCalendarSummaryView,
    TimelineCalendarChunkView,
...
urlpatterns = [
    ...
    path("timeline/calendar/summary/", TimelineCalendarSummaryView.as_view(), name="timeline-calendar-summary"),
    path("timeline/calendar/chunk/", TimelineCalendarChunkView.as_view(), name="timeline-calendar-chunk"),
